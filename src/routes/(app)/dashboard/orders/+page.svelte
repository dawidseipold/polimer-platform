<script lang='ts'>
  ...
  // Table
	...
	import { addColumnFilters, addGridLayout, addHiddenColumns, addPagination, addSelectedRows, addSortBy, matchFilter, textPrefixFilter } from "svelte-headless-table/plugins";
  ...
  const { headerRows, pageRows, tableAttrs, tableHeadAttrs, tableBodyAttrs, pluginStates }  = tableViewModel;
...
<div class='flex flex-col space-y-4 p-8'>
  ...
  <div class='flex gap-y-4'>
    <table class='p-4 w-full' {...$tableAttrs}>
